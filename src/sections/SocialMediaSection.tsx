        ...
        <section className="flex flex-col items-center p-8">
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-6">
                <a href="https://x.com/haibusocial" target="_blank" rel="noopener noreferrer">
                    <ShineBorder className="w-40 h-40 flex flex-col items-center justify-center" color="black" borderWidth={2}>
                ...
                <a href="https://t.me/haibusocial" target="_blank" rel="noopener noreferrer">
                    <ShineBorder className="w-40 h-40 flex flex-col items-center justify-center" color="blue" borderWidth={2}>
                        <svg className="w-8 h-8 text-blue-500 lucide lucide-send" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="https://github.com/Haibu-Project/" target="_blank" rel="noopener noreferrer">
                    <ShineBorder className="w-40 h-40 flex flex-col items-center justify-center" color="purple" borderWidth={2}>
                        <svg className="w-8 h-8 text-purple-950 lucide lucide-github" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
